...
public class ChatWebSocketHandler {
    ...
    public void onMessage(Session user, String message) {
        ...
        }else userHandler.userUsernameMap.get(user).getChannel().broadcastMessage(userHandler.userUsernameMap.get(user).getName(),message,"message",userHandler.userUsernameMap,channelHandler.getChannelNames());
        channelHandler.refreshChannelList(userHandler.userUsernameMap);
